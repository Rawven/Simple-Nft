package com.topview.result;

import com.topview.model.CommonSerializable;
import lombok.Data;
...
public class RpcResult<T> extends CommonSerializable {
    ...
    public static <T> RpcResult<T> operateSuccess(T data) {
        return new RpcResult<>(true, "调用成功", data);
    }
